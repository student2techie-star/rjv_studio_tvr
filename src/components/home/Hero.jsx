...
function HeroSlideshowChip() {
  ...
  return (
    <motion.div
      className="absolute -top-10 -right-6 lg:-right-10 hidden lg:block w-48 h-68 rounded-t-[64px] rounded-b-[28px] overflow-hidden border-[4px] border-white shadow-[0_20px_50px_rgba(15,23,42,0.4)] rotate-3 transition-transform duration-500 hover:rotate-0 z-20 bg-slate-950"
